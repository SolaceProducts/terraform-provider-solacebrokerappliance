		...
		Attributes: []*broker.AttributeInfo{
			{
				...
				MarkdownDescription: "The name of the ACL Profile. Deprecated since 2.14. Replaced by subscribeTopicExceptions.",
				Identifying:         true,
				Required:            true,
				ReadOnly:            true,
			...
			},
			{
				...
				MarkdownDescription: "The name of the Message VPN. Deprecated since 2.14. Replaced by subscribeTopicExceptions.",
				Identifying:         true,
				Required:            true,
				ReadOnly:            true,
				RequiresReplace:     true,
			...
			},
			{
				...
				MarkdownDescription: "The topic for the exception to the default action taken. May include wildcard characters. Deprecated since 2.14. Replaced by subscribeTopicExceptions.",
				Identifying:         true,
				Required:            true,
				RequiresReplace:     true,
				Deprecated:          true,
