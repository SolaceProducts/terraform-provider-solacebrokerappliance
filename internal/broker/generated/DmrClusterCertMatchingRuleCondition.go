		...
		Attributes: []*broker.AttributeInfo{
			{
				...
				MarkdownDescription: "Link Attribute to be compared with certificate content. Either an attribute or an expression must be provided on creation, but not both.\n\nThe minimum access scope/level required to retrieve this attribute is \"global/read-only\". The default value is `\"\"`.",
